...
class GFSK2_RX_BLUE(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GFSK2_RX_BLUE", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GFSK2_RX_BLUE")
        ...
        self.settings = Qt.QSettings("GNU Radio", "GFSK2_RX_BLUE")
        ...
        self.iio_fmcomms2_source_0.set_frequency(434520000)
...
def main(top_block_cls=GFSK2_RX_BLUE, options=None):
